...
strA = cv2.imread("./MSRS/Infrared/train/MSRS/00054N.png", 0).astype(np.float32)
strB = cv2.imread("./MSRS/Visible/train/MSRS/00054N.png", 0).astype(np.float32)
strF = cv2.imread("./MSRS/Fusion/train/MSRS/00054N.png", 0).astype(np.float32)
